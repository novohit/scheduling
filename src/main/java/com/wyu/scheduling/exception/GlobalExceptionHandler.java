...
public class GlobalExceptionHandler {
    ...
    public ResultVO exceptionHandler(HttpServletRequest request, Exception e) {
        ...
        e.printStackTrace();
        return ResultVO.error(method + " " + requestUrl);
    }
    ...
    public ResponseEntity<ResultVO> httpExceptionHandler(HttpServletRequest request, CommonException e) {
        String requestUrl = request.getRequestURI();
        String method = request.getMethod();

        ResultVO resultVO = new ResultVO(e.getCode(), e.getMessage(), method + " " + requestUrl);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpStatus httpStatus = HttpStatus.resolve(e.getHttpStatusCode());
        return new ResponseEntity<>(resultVO, headers, httpStatus);
    }
    ...
    public ResultVO methodArgumentNotValidExceptionHandler(HttpServletRequest request, MethodArgumentNotValidException e) {
        ...
        return ResultVO.error(ResultEnum.PARAM_ERROR.getCode(), errorMsg, method + " " + requestUrl);
    }
    ...
    public ResultVO constraintViolationExceptionHandler(HttpServletRequest request, ConstraintViolationException e) {
        ...
        return ResultVO.error(ResultEnum.PARAM_ERROR.getCode(), errorMsg.toString(), method + " " + requestUrl);
    }
